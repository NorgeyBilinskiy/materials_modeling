...
def run_predictions_for_selected_materials() -> Dict[str, Dict[str, float]]:
    ...
    def _predict_for_material(material_dir: Path) -> Dict[str, float]:
        ...
        try:
            from src.models.cgcnn.predict import predict_multiple_structures as cgcnn_multi
        ...
        try:
            from src.models.megnet.predict import predict_multiple_structures as megnet_multi
        ...
        try:
            from src.models.schnet.predict import predict_multiple_structures as schnet_multi
        ...
        try:
            from src.models.mpnn.predict import predict_multiple_structures as mpnn_multi
